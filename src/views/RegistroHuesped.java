...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNreserva.setText(Sesion.getInstance().idEntreFrame);
	...
	private void guardar() {
		if (txtFechaN.getDate() != null) {
			...
			int idreserva =  Integer.valueOf(txtNreserva.getText());


			Huespedes huesped = new Huespedes( nombre, apellido, java.sql.Date.valueOf(fechanacimiento), nacionalidad, telefono, idreserva);
